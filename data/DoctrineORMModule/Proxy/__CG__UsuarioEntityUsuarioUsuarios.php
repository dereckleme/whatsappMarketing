 ...
 */
class UsuarioUsuarios extends \Usuario\Entity\UsuarioUsuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Usuario\\Entity\\UsuarioUsuarios' . "\0" . 'idusuario', '' . "\0" . 'Usuario\\Entity\\UsuarioUsuarios' . "\0" . 'login', '' . "\0" . 'Usuario\\Entity\\UsuarioUsuarios' . "\0" . 'senha', '' . "\0" . 'Usuario\\Entity\\UsuarioUsuarios' . "\0" . 'email', '' . "\0" . 'Usuario\\Entity\\UsuarioUsuarios' . "\0" . 'nivel');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioUsuarios $proxy) {
